...
![Creating a new account](/images/_shared/login_screen.webp)
...
![Enable premium sync](/images/usage-guides/index/create_account_enable_sync.webp)
...
![Sign-up with existing premium subscription using a wrong password](/images/usage-guides/index/premium_signup_failed.webp)
...
If you purchased a [rotki Premium](https://rotki.com/products/) subscription after creating your local account, you can activate it at any time by adding your API key and secret under **API Keys → rotki Premium** in the app. See [rotki Premium API Credentials](/premium/api-keys) for the full setup instructions.
...
![Sync data with rotki Server](/images/usage-guides/index/premium_set_sync_data.webp)
...
![Replace local database with remote backup](/images/usage-guides/index/premium_replace_local_db_with_remote.webp)
...
![Manual DB sync](/images/usage-guides/index/premium_manual_db_sync.webp)

### Manual Sync

You can manually sync your database by clicking the "cloud" icon in the toolbar.

![Manual DB sync](/images/usage-guides/index/premium_automatic_db_sync_failed.webp)
