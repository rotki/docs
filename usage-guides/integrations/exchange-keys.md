...
![List of connected exchanges](/images/usage-guides/integrations/exchange-keys/add_exchange_2.webp)
...
![Add API keys for a new exchange](/images/_shared/add_exchange_1.webp)
...
![Simple API key permissions](/images/usage-guides/integrations/exchange-keys/add_api_keys_binance.webp)
...
![Granular API key permissions](/images/usage-guides/integrations/exchange-keys/add_api_keys_coinbase.webp)
...
![Kraken account type](/images/usage-guides/integrations/exchange-keys/add_kraken.webp)
...
![Edit Binance in the exchanges section](/images/usage-guides/integrations/exchange-keys/edit_binance.webp)
...
![Binance markets selection](/images/usage-guides/integrations/exchange-keys/binance_markets_selection.webp)
