...
![Calendar view](/images/usage-guides/integrations/calendar/overview.png)

![Add calendar event](/images/usage-guides/integrations/calendar/add_event.png)
...
![Automatic events setting](/images/usage-guides/integrations/calendar/automatic_events_setting.png)

## Event reminder

The notification for the reminder of your event looks like this.

![Notification for the reminder](/images/usage-guides/integrations/calendar/reminder.png)
...
1. Click the `Cog button` on the calendar page.
   ![Click cog button](/images/usage-guides/integrations/calendar/connect_google_1.png)
...
3. Click `Continue with Google` and choose your Gmail account to continue.
   ![Continue with google](/images/usage-guides/integrations/calendar/connect_google_2.png)

4. After it's done, it will look like this. Click `Sync Now` to sync the events to Google Calendar on your selected account.
   ![Connected to google calendar](/images/usage-guides/integrations/calendar/connect_google_3.png)
